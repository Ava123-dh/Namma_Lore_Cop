...
const WesternChalukyaTimeline = () => {
  ...
  const events = [
    { id: 'wc-1', year: '973 CE', title: "Tailapa II\'s Overthrow", subtitle: 'Restores Chalukya line', fullText: "Tailapa II exploited Rashtrakuta decline to defeat Karka II and restore Chalukya authority, stabilizing the Deccan for centuries.", category: 'Politics', highlights: ['Revived Chalukya rule'], image: 'https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=400&h=300&fit=crop' },
    { id: 'wc-2', year: '1076 CE', title: "Vikramaditya VI\'s Accession", subtitle: 'Golden age', fullText: 'Vikramaditya VI ushered a golden age with patronage to literature and architecture, strengthening central authority.', category: 'Culture', highlights: ['Vikrama era', 'Legal and literary works'], image: 'https://images.unsplash.com/photo-1481627834876-b7833e8f5570?w=400&h=300&fit=crop' },
  ]
    ...
    <div className="min-h-screen py-12 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl border border-primary-200">
          ...
          <p className="text-gray-700 leading-relaxed">The Western Chalukyas restored stability in the Deccan after the Rashtrakuta period and contributed to regional literature and temple styles.</p>
        </div>

        <div className="mt-8 p-6 bg-white rounded-lg border border-gray-200">
          <h4 className="font-bold text-lg mb-3">Explore more</h4>
          <ul className="list-disc pl-5 text-primary-700"><li><a href="https://en.wikipedia.org/wiki/Western_Chalukya_Empire" target="_blank" rel="noreferrer" className="underline">Western Chalukya Empire — Wikipedia</a></li></ul>
        </div>
      </div>
      <ChatBot />
    </div>
