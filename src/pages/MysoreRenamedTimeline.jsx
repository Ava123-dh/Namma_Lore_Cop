  ...
  const events = [
    {
      ...
      fullText: 'In 1973 the State of Mysore was officially renamed Karnataka, reflecting the region\'s geographic and cultural identity and uniting Kannada speakers under the state name.',
      category: 'Politics',
      highlights: ['Official renaming', 'Cultural identity consolidation', 'Administrative continuity'],
      image: 'https://images.unsplash.com/photo-1604420805055-aa0e0214b7e5?w=1200&h=600&fit=crop',
    },
  ]
