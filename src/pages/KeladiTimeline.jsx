...
const KeladiTimeline = () => {
  ...
  const events = [
    { id: 'kel-1', year: '1499 CE', title: 'Founding by Chaudappa', subtitle: 'Keladi established', fullText: 'Chaudappa Nayaka established control in Shimoga-area, fortifying Keladi and laying the foundations for the Keladi Nayaka kingdom.', category: 'Politics', highlights: ['Founding of Keladi'], image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=400&h=300&fit=crop' },
    { id: 'kel-2', year: '1629 CE', title: "Shivappa Nayaka's Reforms", subtitle: 'Ashta Bhaga revenue system', fullText: 'Shivappa Nayaka reformed land revenue with the Ashta Bhaga system, strengthening administration and trade.', category: 'Governance', highlights: ['Ashta Bhaga system', 'Administrative reforms'], image: 'https://images.unsplash.com/photo-1582407947304-fd86f028f716?w=400&h=300&fit=crop' },
  ]
    ...
    <div className="min-h-screen py-12 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl border border-primary-200">
          ...
          <p className="text-gray-700 leading-relaxed">Keladi Nayakas ruled parts of Malnad and coastal Karnataka, noted for administrative reforms and naval trade.</p>
        </div>

        <div className="mt-8 p-6 bg-white rounded-lg border border-gray-200">
          <h4 className="font-bold text-lg mb-3">Explore more</h4>
          <ul className="list-disc pl-5 text-primary-700"><li><a href="https://en.wikipedia.org/wiki/Keladi_Nayaka" target="_blank" rel="noreferrer" className="underline">Keladi Nayaka — Wikipedia</a></li></ul>
        </div>
      </div>
      <ChatBot />
    </div>
