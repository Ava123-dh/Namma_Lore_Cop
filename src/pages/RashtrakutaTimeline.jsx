...
const RashtrakutaTimeline = () => {
  ...
  const events = [
    { id: 'r-1', year: '753 CE', title: 'Founding by Dantidurga', subtitle: 'End of Badami Chalukyas', fullText: 'Dantidurga defeated Kirtivarman II and founded the Rashtrakuta Empire, fixing Manyakheta as capital and expanding across the Deccan.', category: 'Politics', highlights: ['Founded Manyakheta', 'Consolidated Deccan'], image: 'https://images.unsplash.com/photo-1609920658906-8223652d5f5d?w=400&h=300&fit=crop' },
    { id: 'r-2', year: '756–774 CE', title: 'Krishna I\'s Conquests', subtitle: 'Kailasa at Ellora', fullText: "Krishna I subdued regional rivals and sponsored the monumental Kailasa temple at Ellora, showcasing Rashtrakuta patronage.", category: 'Culture', highlights: ['Kailasa temple', 'Territorial expansion'], image: 'https://images.unsplash.com/photo-1548013146-72479768bada?w=400&h=300&fit=crop' },
  ]
    ...
    <div className="min-h-screen py-12 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl border border-primary-200">
          ...
          <p className="text-gray-700 leading-relaxed">The Rashtrakutas were a major Deccan power responsible for notable architecture and wide-ranging campaigns across India.</p>
        </div>

        <div className="mt-8 p-6 bg-white rounded-lg border border-gray-200">
          <h4 className="font-bold text-lg mb-3">Explore more</h4>
          <ul className="list-disc pl-5 text-primary-700"><li><a href="https://www.worldhistory.org/Rashtrakuta_Dynasty/" target="_blank" rel="noreferrer" className="underline">Rashtrakuta Dynasty — World History</a></li></ul>
        </div>
      </div>
      <ChatBot />
    </div>
