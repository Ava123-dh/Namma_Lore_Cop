...
const TipuTimeline = () => {
  ...
  const events = [
    { id: 't1', year: '1784', title: 'First Anglo-Mysore War End', subtitle: 'Treaty of Mangalore', fullText: 'Tipu signed the Treaty of Mangalore, restoring borders and enabling military reorganization.', category: 'Military', highlights: ['Treaty of Mangalore'], image: 'https://images.unsplash.com/photo-1598977123118-4e30ba3c4f5b?w=400&h=300&fit=crop' },
    { id: 't2', year: '1792', title: 'Treaty of Seringapatam', subtitle: 'Major territorial losses', fullText: 'After defeats by Cornwallis, Tipu ceded significant territory, paid indemnity, and sent sons as hostages under the treaty.', category: 'Politics', highlights: ['Territorial loss', 'Hostage princes'], image: 'https://images.unsplash.com/photo-1609920658906-8223652d5f5d?w=400&h=300&fit=crop' },
    { id: 't3', year: '1799', title: 'Srirangapatna Fall', subtitle: 'Tipu dies in battle', fullText: 'In the Fourth Anglo-Mysore War, Tipu Sultan died defending Srirangapatna; Mysore was partitioned and effectively controlled by the British.', category: 'Military', highlights: ['Tipu\'s death', 'End of major resistance'], image: 'https://images.unsplash.com/photo-1587135941948-670b381f08ce?w=400&h=300&fit=crop' }
  ]
    ...
    <div className="min-h-screen py-12 bg-gradient-to-b from-slate-50 to-white">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-16 p-8 bg-gradient-to-r from-primary-50 to-blue-50 rounded-xl border border-primary-200">
          ...
          <p className="text-gray-700 leading-relaxed">Tipu Sultan was an innovator in military technology and a fierce opponent of British expansion, ultimately falling at Srirangapatna.</p>
        </div>

        <div className="mt-8 p-6 bg-white rounded-lg border border-gray-200">
          <h4 className="font-bold text-lg mb-3">Explore more</h4>
          <ul className="list-disc pl-5 text-primary-700"><li><a href="https://en.wikipedia.org/wiki/Tipu_Sultan" target="_blank" rel="noreferrer" className="underline">Tipu Sultan — Wikipedia</a></li></ul>
        </div>
      </div>
      <ChatBot />
    </div>
